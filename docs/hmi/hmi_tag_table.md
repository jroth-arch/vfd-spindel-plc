...
| HMI | `"DB_Status".HMI_StatusColor` | USInt | 0=READY, 1=RUNNING, 2=TRIP, 3=RUNNING with RPM=0 (warning) |
...
### HMI Status Color (`"DB_Status".HMI_StatusColor`)
| Hodnota | Stav | Význam |
|---|---|---|
| 0 | READY | Test neběží |
| 1 | RUNNING | Test běží normálně |
| 2 | TRIP | Chyba / safety trip |
| 3 | WARNING | Test běží, ale setpoint `Spindle.Speed_RPM = 0` |
